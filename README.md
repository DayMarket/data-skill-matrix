...
- [Staff ML Engineer (IC5)](./hard_skills/machine_learning/Staff%20ML%20Engineer%20(IC5).md) — архетипы Staff-инженеров, маппинг на матрицу и процесс перевода в IC5
